...
// SlurmVirtualKubeletConfigurationPathRefs returns pointers to all of the KubeletConfiguration fields that contain filepaths.
...
func SlurmVirtualKubeletConfigurationPathRefs(kc *SlurmVirtualKubeletConfiguration) []*string {
	var paths []*string
