...
import (
	...
	"github.com/chriskery/slurm-bridge-operator/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type KubeclusterV1alpha1Interface interface {
	RESTClient() rest.Interface
	SlurmBridgeJobsGetter
}
...
func (c *KubeclusterV1alpha1Client) SlurmBridgeJobs(namespace string) SlurmBridgeJobInterface {
	return newSlurmBridgeJobs(c, namespace)
}
